...
# ==========================================
    ...
    if st.session_state.db_pengajuan_admin:
        ...
        # 3. CETAK DOKUMEN PROPOSAL & PREVIEW (DENGAN TOGGLE PERSISTENT)
        st.markdown("---")
        st.subheader("🖨️ Cetak Dokumen Proposal Anggaran")
        
        # Menggunakan toggle agar preview aktif terus dan bisa dicetak berulang-ulang
        show_preview = st.toggle("🖨️ Aktifkan Preview & Cetak Dokumen PDF", value=False)
